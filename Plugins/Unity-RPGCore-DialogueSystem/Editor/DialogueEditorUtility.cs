...
namespace RPGCore.Dialogue.Editor
{
	...
	{
		//资源保存的路径
		private static readonly string dialogueItemSavePath = "Assets/Datas/DialogueDate/Items/";
		private static readonly string dialogueGroupSavePath = "Assets/Datas/DialogueDate/Groups/";
